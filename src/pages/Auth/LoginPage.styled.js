...
// Left panel uses tenant sidebar color → primary dark gradient
export const LeftPanel = styled.div`
  flex: 0 0 42%;
  background: linear-gradient(
    145deg,
    ${({ theme }) => theme.colors.bgSidebar}      0%,
    ${({ theme }) => theme.colors.bgSidebarHover} 60%,
  ...
  /* Decorative orbs using tenant primary color */
  &::before {
    content: '';
    position: absolute;
    top: -80px; right: -80px;
