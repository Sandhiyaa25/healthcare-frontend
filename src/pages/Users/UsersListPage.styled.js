...
export const UserCell = styled.div`display: flex; align-items: center; gap: 10px;`;
...
export const ActionsCell = styled.div`display: flex; align-items: center; gap: 6px;`;
...
export const ErrMsg = styled.div`
  ...
  border-radius: ${({ theme }) => theme.radii.sm};
  color: ${({ theme }) => theme.colors.danger}; font-size: 13px;
`;
...
export const ModalTitle = styled.h3`
  font-size: 16px; font-weight: 600; color: ${({ theme }) => theme.colors.textPrimary};
`;

export const CloseBtn = styled.button`
  width: 28px; height: 28px; border-radius: 50%;
  display: flex; align-items: center; justify-content: center;
  font-size: 18px; color: ${({ theme }) => theme.colors.textMuted};
  background: ${({ theme }) => theme.colors.bgBase};
  &:hover { color: ${({ theme }) => theme.colors.textPrimary}; }
`;

export const FieldGrid = styled.div`display: grid; grid-template-columns: 1fr 1fr; gap: 14px;`;

export const Field = styled.div`display: flex; flex-direction: column; gap: 5px;`;

export const Label = styled.label`
  font-size: 12px; font-weight: 500; color: ${({ theme }) => theme.colors.textPrimary};
`;

export const Input = styled.input`
  padding: 9px 12px;
  border: 1.5px solid ${({ theme, $error }) => $error ? theme.colors.danger : theme.colors.border};
  border-radius: ${({ theme }) => theme.radii.sm};
  font-size: 13px;
  background: ${({ theme }) => theme.colors.bgCard};
  color: ${({ theme }) => theme.colors.textPrimary};
...
export const FieldErr = styled.p`
  font-size: 11px; color: ${({ theme }) => theme.colors.danger};
`;

export const PwdWrap = styled.div`position: relative; display: flex; align-items: center;`;

export const PwdInput = styled(Input)`padding-right: 38px;`;

export const PwdEye = styled.button`
